...
func (s *SqliteRepositoryTestSuite) TestSqliteUserRepository_CreateUser() {
...
func (s *SqliteRepositoryTestSuite) TestSqliteUserRepository_GetUserByID() {
	nowTime := time.Now().UTC().Format("2006-01-02 15:04:05")
...
func (s *SqliteRepositoryTestSuite) TestSqliteUserRepository_GetUserByEmail() {
	nowTime := time.Now().UTC().Format("2006-01-02 15:04:05")
...
func (s *SqliteRepositoryTestSuite) TestSqliteUserRepository_UpdateUser() {
	nowTime := time.Now().UTC().Format("2006-01-02 15:04:05")
